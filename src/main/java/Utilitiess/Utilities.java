...
public class Utilities extends TestBase {
	...
	public void LogintoApplication(String un, String pwd, String striD){
		username.sendKeys(un);
		password.sendKeys(pwd);
		storeid.sendKeys(striD);
		//loginbtn.click();
	}
	...
	public void newloaninitialization(String ssn1, String ssn2, String ssn3){
		...
		ss1_txtbox.sendKeys(ssn1);
		ss2_txtbox.sendKeys(ssn2);
		ss3_txtbox.sendKeys(ssn3);
		submit_btn_in_ApplicantSearch_page.click();
		gobtn_in_searchpage.click();
	}
	
	public void transactionsinitialization(String ssn1, String ssn2, String ssn3){
