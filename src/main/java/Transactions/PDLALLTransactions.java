...
public class PDLALLTransactions extends TestBase{
	...
	public void NewPDLByACH(String loanamount, String Collateraltype, String disbtytpe, String acntNbr) throws Exception{
	...
	public void NewPDLByDC(String loanamount, String cardtype) throws Exception{
	...
	public void PDLVoid(String tendertype){
		go_btn.click();
		...
		tenderTypeFirstdd.selectByVisibleText(tendertype);
	...
	public void RescindPDL(String tendertype){
		go_btn.click();
		Select Transactionsdd = new Select(Transactions_dd);
	...
	public void PartialPayment(String payment, String payment_type) throws Exception{
		ExtentHtmlReporter reporter=new ExtentHtmlReporter("C:/Selenium WebDriver/QCProject/Reports/RegressionTesting.html");
		ExtentReports extent=new ExtentReports();
		extent.attachReporter(reporter);
	...
	public void PartialPaymentVoid(String tender_type){
		ExtentHtmlReporter reporter=new ExtentHtmlReporter("C:/Selenium WebDriver/QCProject/Reports/RegressionTesting.html");
		ExtentReports extent=new ExtentReports();
		extent.attachReporter(reporter);
		ExtentTest logger2=extent.createTest("Partial Payment Void Test");
		...
		disbursementTypee.selectByVisibleText(tender_type);
	...
	public void BuyBack(String paymnt_type) throws Exception{
		ExtentHtmlReporter reporter=new ExtentHtmlReporter("C:/Selenium WebDriver/QCProject/Reports/RegressionTesting.html");
		ExtentReports extent=new ExtentReports();
		extent.attachReporter(reporter);
		...
		String payment_type=paymnt_type;
		Select tenderTypedd = new Select(tenderType_dd);
	...
	public void BuyBackVoid(String tender_type){
		ExtentHtmlReporter reporter=new ExtentHtmlReporter("C:/Selenium WebDriver/QCProject/Reports/RegressionTesting.html");
		ExtentReports extent=new ExtentReports();
		extent.attachReporter(reporter);
	...
	public void ACHPrePayment(String payment_type) throws Exception{
		util=new Utilities();
		Go_Btn.click();
		Select Transactionsdd = new Select(Transactions_dd);
	...
	public void ACHPrePaymentVoid(String tendertype){
		Go_Btn.click();
		Select Transactionsdd = new Select(Transactions_dd);
		Transactionsdd.selectByVisibleText("Void");
		go_Button.click();
		Select disbursementTypee = new Select(disbursementType);
		disbursementTypee.selectByVisibleText(tendertype);
		pwd_tb.sendKeys("1234");
